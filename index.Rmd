...
# 4. Conglomeración de variables independientes - Año 2019: 
...
# 5. Conglomeración de variables independientes - Año 2020: 


## 5.1. Preparación de datos para la conglomeración - Año 2020: 
...
## 5.2. Conglomeración con técnica aglomerativa AGNES - Año 2020:
...
```{r include=FALSE}
BDU4$clust = factor(BDU4$clust, levels = c(1:2), labels = c("Muy corrupto o Corrupto","Medianamente corrupto o Poco corrupto"))
```
